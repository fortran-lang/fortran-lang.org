...
layout: book
title: leadz
permalink: /learn/intrinsics/f_leadz
---
### NAME

**leadz**(3f) - \[BIT INQUIRY\] Number of leading zero
bits of an integer
...
the bits of I are zero, the result value is **bit\_size**(i).
...
**bit\_size**(3), **popcnt**(3), **poppar**(3), **trailz**(3)
